...
// A: "number"   
// B: "string"
// C: undefined   *  (in sub excn context, comsole.log before declaratiom)
// D: ReferenceError
...
// B: We don't have to buy bananas   * as op is 0
// C: undefined
// D: 1
...
// let newList = [1, 2, 3].push(4);           This stsat is invalid
...
// console.log(3 + 4 + '5');
// A: "345"
// B: "75"    *(3 + 4 =7 , and 5 is addded after explicitly converting integer to string)
// C: 12
// D: "12"
...
// A: [1, 2, 3, 7 x null, 11]
// B: [1, 2, 3, 11]
// C: [1, 2, 3, 7 x empty, 11]   * (as null also needs to be applied)
// D: SyntaxError
...
// console.log(sayHi.call(person, 21));     //sets this keyword inside current fn and executes it immedieatly
// console.log(sayHi.bind(person, 21));    //creates new fn and sets this keyword to specified obj
